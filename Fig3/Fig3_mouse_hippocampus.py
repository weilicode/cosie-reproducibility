...
if __name__ == "__main__":
    ...
    adata1_rna = sc.read_h5ad('./Fig3_data/Mouse_hippocampus/section3/adata_section3_rna.h5ad')
    adata2_meta = sc.read_h5ad('./Fig3_data/Mouse_hippocampus/section2/adata_section2_meta.h5ad')
    adata2_rna = sc.read_h5ad('./Fig3_data/Mouse_hippocampus/section2/adata_section2_rna.h5ad')
    ...
    emb_path = os.path.join('./Fig3_data/Mouse_hippocampus/', 'COSIE_result')
    s1_embedding = np.load(os.path.join(emb_path, 's1_embedding.npy'))
    s2_embedding = np.load(os.path.join(emb_path, 's2_embedding.npy'))
    ...
    cluster_label = cluster_and_visualize_superpixel(final_embeddings, 
                                                     ...
                                                     swap_xy=True, 
                                                     invert_x=True,
                                                     save_path='COSIE_hippocampus.jpg',
                                                     dpi = 500,
                                                     figscale = 50)
    ## SpaMosaic
    adata_spamosaic = sc.read_h5ad('./Fig3_data/Mouse_hippocampus/SpaMosaic_result/ad_masked_mouse_hippocampus.h5ad')
    spamosaic_embedding_s1 = adata_spamosaic.obsm['merged_emb'][:adata1_meta.shape[0], :]
    spamosaic_embedding_s2 = adata_spamosaic.obsm['merged_emb'][adata1_meta.shape[0]:, :]
    ...
    cluster_label = cluster_and_visualize_superpixel(final_embeddings_spamosaic, 
                                                     data_dict,
                                                     n_clusters=21,
                                                     mode="joint", 
                                                     vis_basis="spatial",  
                                                     ...
                                                     # invert_y=True,
                                                     invert_x=True,
                                                     save_path='SpaMosaic_hippocampus.jpg',
                                                     dpi = 500,
                                                     figscale = 50)

    ## StabMap
    df_emb = pd.read_csv('./Fig3_data/Mouse_hippocampus/StabMap_result/mouse_hippocampus_harmony_embedding.csv')
    ...
    cluster_label = cluster_and_visualize_superpixel(final_embeddings_stabmap, 
                                                     ...
                                                     swap_xy=True, 
                                                     invert_x=True,
                                                     save_path='StabMap_hippocampus.jpg',
                                                     dpi = 500,
                                                     figscale = 50)

    ## Virtual prediction
    os.makedirs("./Mouse_hippocampus_prediction", exist_ok=True)
    adata2_rna_imputed=sc.read_h5ad(os.path.join(emb_path,'adata2_rna_imputed.h5ad'))
    adata2_rna_imputed_norm = create_normalized_adata(adata2_rna_imputed)
    adata2_rna_norm = create_normalized_adata(adata2_rna)

    for gene in ['Ahcyl2', 'Kcnk1', 'Gdi2', 'Adcy1']:
        plot_marker_comparison_superpixel(
            gene,
            adata2_rna_imputed_norm,
            adata2_rna_norm,
            ...
            figscale = 50,
            dpi = 500,   
            save_path = './Mouse_hippocampus_prediction/{}.jpg'.format(gene))
